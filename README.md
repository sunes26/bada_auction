...
**🚨 미해결 이슈 - PlayAuto 문의 중**:
- ❌ **쿠팡 상품 등록 오류 지속**: "필수 구매 옵션이 존재하지 않습니다"
- 📝 **PlayAuto 고객센터 문의 완료** (2026-02-08)
- 상세 내용은 하단 "PlayAuto 카테고리 관리" 섹션 참고

**커밋 해시**:
- `87e619f`: 쿠팡 shop_cd B378 추가
- `65c2a1d`: 채널 분류 디버깅 정보 추가
- `d447412`: 쿠팡 옵션 디버깅 정보 프론트엔드 콘솔 출력
- `718ff46`: 쿠팡 옵션 디버깅 로그 추가
- `1aff10f`: 쿠팡 추천옵션 적용 (수량/1개)
...
| 쿠팡 | **B378**, A027, CPM | **조합형** | N | ⚠️ 아래 이슈 참고 |
| 스마트스토어 | A077 | 독립형 | N | |
| 11번가 | A112 | 독립형 | N | |
| SSG.COM | A524 | 독립형 | N | |
| 롯데ON | A113 | 독립형 | N | |
...
### 🚨 미해결 이슈: 쿠팡 상품 등록 오류 (PlayAuto 문의 중)
...
**발견한 사실**:
- ✅ **실제 쿠팡 shop_cd**: `B378` (A027, CPM이 아님)
- ✅ **쿠팡 추천옵션**: 옵션명 `수량`, 추천단위 `개`
- ❓ **미해결**: 추천옵션 적용 후에도 "필수 구매 옵션" 오류 지속

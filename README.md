...
> ⚠️ **참고**: PlayAuto 카테고리 코드(sol_cate_no)는 전면 재매핑 예정

### 마켓별 shop_cd 코드

| 마켓 | shop_cd | 상품 등록 방식 |
|------|---------|---------------|
| 옥션 | A001, AUCTION | 단일상품 (옵션없음) |
| 지마켓 | A006, GMK | 단일상품 (옵션없음) |
| 쿠팡 | A027, CPM | 단일상품 (옵션없음) |
| 스마트스토어 | A077 | 일반상품 (독립형 옵션) |
| 11번가 | A112 | 일반상품 (독립형 옵션) |
| SSG.COM | A524 | 일반상품 |
| 롯데ON | A113 | 일반상품 |
| GS SHOP | A522 | 일반상품 |

  ...
  return (
    <>
      ...
      {!hiddenSections['additionalImages'] && (
        <section className="w-full py-16 px-8 bg-slate-50 relative">
          <SectionDeleteButton sectionKey="additionalImages" onSectionDelete={onSectionDelete} />
          <div className="max-w-4xl mx-auto">
            <h3 className="text-2xl font-bold text-center mb-8 text-slate-800">추가 이미지</h3>
            <div className="flex flex-col gap-6 items-center">
              ...
              {onAddImageSlot && (
                <button
                  ...
                  className="w-full max-w-md py-4 border-2 border-dashed border-slate-300 rounded-xl text-slate-500 hover:border-indigo-400 hover:text-indigo-600 transition-colors flex items-center justify-center gap-2"
                >
